CLASS zcl_material_information_cm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_material_information_cm IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    DATA material_info TYPE REF TO zcl_material_information_cm.
    material_info = NEW zcl_material_information_cm(  ).
